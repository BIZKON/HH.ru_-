...
export default function DashboardPage() {
  ...
  useEffect(() => {
    applyFilters()
  }, [applications, selectedVacancy, minScore, maxScore, statusFilter, searchQuery])
  ...
  const stats = {
    ...
    avgScore:
      filteredApplications.length > 0
        ...
        : 0,
    excellent: filteredApplications.filter((app) => app.score >= 80).length,
    good: filteredApplications.filter((app) => app.score >= 60 && app.score < 80).length,
  }
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-bold">Дашборд кандидатов</h1>
          <p className="text-muted-foreground">Все найденные и оцененные кандидаты из базы данных</p>
        </div>
